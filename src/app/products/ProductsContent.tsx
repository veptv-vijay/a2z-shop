  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        {searchQuery && (
          <p className="text-gray-600 mb-4">Results for: <strong>"{searchQuery}"</strong> — {filtered.length} found</p>
        )}
          ...
          <div className="hidden md:block w-56 flex-shrink-0">
            <div className="bg-white rounded-xl border border-gray-200 p-4 sticky top-20">
              ...
              <div>
                ...
                <input type="range" min="100" max="100000" value={priceRange}
                  onChange={(e) => setPriceRange(Number(e.target.value))} className="w-full accent-green-600" />
              </div>
            </div>
          </div>
