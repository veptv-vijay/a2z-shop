...
import { Package, CheckCircle, Clock, Truck, ArrowLeft } from 'lucide-react'
        ...
        {success && (
          <div className="bg-green-50 border border-green-300 rounded-xl p-4 mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-green-600 text-sm">Your order has been placed. We will contact you for delivery.</p>
            </div>
          </div>
        )}
                ...
                <div key={order.id} className="bg-white border border-gray-200 rounded-xl p-5">
                  <div className="flex items-start justify-between flex-wrap gap-3 mb-4">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">{new Date(order.created_at).toLocaleDateString('en-IN', { day: 'numeric', month: 'long', year: 'numeric' })}</p>
                    </div>
                  ...
                  <div className="border-t border-gray-100 pt-4">
                    <p className="text-xs text-gray-500 mb-2 font-semibold">ITEMS ORDERED</p>
                  ...
                  <div className="border-t border-gray-100 pt-3 mt-2 grid grid-cols-2 gap-3 text-xs text-gray-500">
                    ...
                    <div>
                      ...
                      {order.tracking_number && (
                        <div className="mt-1">
                          <p className="font-semibold text-gray-700">Tracking No.</p>
                          <p className="font-mono text-green-700">{order.tracking_number}</p>
                        </div>
                      )}
                    </div>
                  </div>
